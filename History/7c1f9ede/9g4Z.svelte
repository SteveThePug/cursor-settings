...
scene.add(light);
const light2 = new THREE.PointLight(0x330033, 100);
light2.position.set(1,1,1);
scene.add(light2);
//Create a box
const boxGeometry = new THREE.BoxGeometry(1, 1, 1);
const boxMaterial = new THREE.MeshPhongMaterial({ color: 0x0022ff ,emissive: 0x220022, specular: 0x224455});
